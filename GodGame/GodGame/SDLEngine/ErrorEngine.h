...
public:
	...
	*/
	...
	/**
	 * \brief Sets the Data functions for a given error code.
	 * \warn This will override anything that is already there.
	 * \param code The error the function belongs too
	 * \param dataFunc The function to add.
	*/
	...
	*/
	...
	/**
	 * \brief Add a new error message.
	 * This will call the onAdd callback if there is one.
	 * \param code The error code for this error message.
	 * \param msg The error message as a string.
	 * \note If the onAdd callback is nullptr error type is set to Err_Type_Fatel.
	*/
